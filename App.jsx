  ...
  return (
    <div style={{margin:"16px 16px 0"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
        {featured.map((s,i)=>(
           <div key={s.id} onClick={()=>onNavigate("store-d",s)}style={{background:"#fff",border:"1.5px solid #dde2f0",borderRadius:16,padding:"16px 14px",cursor:"pointer",boxShadow:"0 2px 10px rgba(8,27,75,0.06)",position:"relative"}}>
